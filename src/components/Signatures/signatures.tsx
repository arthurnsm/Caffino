...
function Signature(){
    return(
        <section className="md:p-20 p-10 mt-15 md:mt-10 flex flex-col align-center justify-center bg-[#ffffff]">
            ...
            <div className='mt-10 flex flex-col md:flex-row hover:cursor-pointer justify-center gap-12'>
